...
public class TransferUnit {
	...
	private double airNodeOutletTemperature, fluidNodeMassFlow;
	private ThState fluidNodeInletState, fluidNodeOutletState = new ThState(ThFluid.R245fa);


	private double totalTransferCoefficient, enthalpyTransfered, fluidTransferCoefficient, airTransferCoefficient;
	 ...
	 */
	public TransferUnit(AircooledCondenser condenser, double airNodeInletTemperature, ThState fluidNodeInletState, double fluidNodeMassFlow){
		...
		airNodeOutletTemperature = airNodeInletTemperature + enthalpyTransfered/cpAir;
		fluidNodeOutletState.pressure = fluidNodeInletState.pressure;
		fluidNodeOutletState.enthalpy = fluidNodeOutletState.enthalpy + enthalpyTransfered;
	}
	...
	/**
	 * 
	 * @return defined flow pattern
	 */
	private FlowPattern determineFlowPattern(){
		//TODO to check by FD
	...
	public ThState getFluidNodeOutletState(){
		return fluidNodeOutletState;
	}

	public double getairNodeOutletTemperature(){
		return airNodeOutletTemperature;
	}
}
