...
public class AircooledCondenser {
  ...
  public void printFlowPatternMap(ThFluid fluid){
    ...
    for(int i=1;i<nPoints-1;i++){
       ...
       HeatTransferLocalUnit transferUnit = new HeatTransferLocalUnit(this, airNodeInletTemperature, fluidState);
  ...
  public class HeatTransferLocalUnit {
   ...
   // @SuppressWarnings("unused")
     ...
     */
    public HeatTransferLocalUnit(AircooledCondenser condenser, double airNodeInletTemperature, ThState fluidNodeInletState){
